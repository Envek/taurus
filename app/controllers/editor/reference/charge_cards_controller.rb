...
class Editor::Reference::ChargeCardsController < Editor::BaseController
  active_scaffold :charge_card do |config|
    ...
    config.list.columns = [:teaching_place, :assistant_teaching_place, :lesson_type, :discipline, :hours_quantity, :hours_per_week, :weeks_quantity, :groups, :preferred_classrooms]
